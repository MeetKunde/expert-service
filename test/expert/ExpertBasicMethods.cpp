...
TEST_CASE("Importing task(shapes part) and exporting empty solution from expert", "[expert]") {
  ...
  const json expectedLines{
    {{"object", {{"a", 0.28484848141670227}, {"b",40.25059127807617}, {"end1Id","jxgBoard1P79"}, {"end2Id","jxgBoard1P81"}, {"id","jxgBoard1L83"}, {"pointsOn", std::vector<std::string>{"jxgBoard1P79","jxgBoard1P108","jxgBoard1P98","jxgBoard1P86","jxgBoard1P81"}}, {"type",DependencyType::EQUATION}}}, {"position",0}},
    {{"object", {{"a", 0.0}, {"b",33.78289794921875}, {"end1Id","jxgBoard1P47"}, {"end2Id","jxgBoard1P106"}, {"id","jxgBoard1L64"}, {"pointsOn", std::vector<std::string>{"jxgBoard1P47","jxgBoard1P62","jxgBoard1P98","jxgBoard1P106"}}, {"type",DependencyType::SEGMENT_LENGTH}}}, {"position",1}},
    {{"object", {{"a", 0.0}, {"b",-59.8684196472168}, {"end1Id","jxgBoard1P100"}, {"end2Id","jxgBoard1P102"}, {"id","jxgBoard1L49"}, {"pointsOn", std::vector<std::string>{"jxgBoard1P100","jxgBoard1P47","jxgBoard1P60","jxgBoard1P36","jxgBoard1P102"}}, {"type",DependencyType::ANGLE_MEASURE}}}, {"position", 2}}
  };

  const json expectedCircles{
    {{"object", {{"centerId","jxgBoard1P20"}, {"cx",72.79605102539063}, {"cy",48.02631759643555}, {"id","jxgBoard1C24"}, {"pointsOn", std::vector<std::string>{"jxgBoard1P86","jxgBoard1P32","jxgBoard1P30","jxgBoard1P22"}}, {"r",30.217369079589844}}}, {"position",0}},
    {{"object", {{"centerId","jxgBoard1P25"}, {"cx",101.74343872070313}, {"cy",16.1842041015625}, {"id","jxgBoard1C29"}, {"pointsOn", std::vector<std::string>{"jxgBoard1P32","jxgBoard1P27","jxgBoard1P104","jxgBoard1P30"}}, {"r",29.262624740600586}}},{"position",1}},
    {{"object", {{"centerId","jxgBoard1P34"}, {"cx",34.638153076171875}, {"cy",-51.71052932739258}, {"id","jxgBoard1C38"}, {"pointsOn", std::vector<std::string>{"jxgBoard1P60","jxgBoard1P36"}}, {"r",24.057022094726563}}}, {"position",2}}
  };
...
TEST_CASE("Importing task(part 1) and exporting empty solution from expert", "[expert]") {
  ...
  const json expectedLengths = {
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",0}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|AA|"}, {"variables",std::vector<std::string>{"|AA|"}}}}, {"object2",{{"value","0"}, {"variables", std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::SEGMENT_LENGTH}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",3}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|BB|"}, {"variables",std::vector<std::string>{"|BB|"}}}}, {"object2",{{"value","0"}, {"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::SEGMENT_LENGTH}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",6}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|CC|"}, {"variables",std::vector<std::string>{"|CC|"}}}}, {"object2",{{"value","0"}, {"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::SEGMENT_LENGTH}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",21}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"value","|AC|"}, {"variables",std::vector<std::string>{"|AC|"}}}}, {"object2",{{"value","5*x"}, {"variables",std::vector<std::string>{"x"}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type",DependencyType::SEGMENT_LENGTH}}
  };

  const json expectedMeasures = {
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",1}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>AAA|"}, {"variables",std::vector<std::string>{"|>AAA|"}}}}, {"object2",{{"value","0"}, {"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",2}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<AAA|"}, {"variables",std::vector<std::string>{"|<AAA|"}}}}, {"object2",{{"value","360"}, {"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",4}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>BBB|"}, {"variables",std::vector<std::string>{"|>BBB|"}}}}, {"object2",{{"value","0"}, {"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",5}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<BBB|"}, {"variables",std::vector<std::string>{"|<BBB|"}}}}, {"object2",{{"value","360"}, {"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",7}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>CCC|"}, {"variables",std::vector<std::string>{"|>CCC|"}}}}, {"object2",{{"value","0"}, {"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",8}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<CCC|"}, {"variables",std::vector<std::string>{"|<CCC|"}}}}, {"object2",{{"value","360"}, {"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",9}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>BAB|"}, {"variables",std::vector<std::string>{"|>BAB|"}}}}, {"object2",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",10}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<BAB|"}, {"variables",std::vector<std::string>{"|<BAB|"}}}}, {"object2",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",11}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>CAC|"}, {"variables",std::vector<std::string>{"|>CAC|"}}}}, {"object2",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",12}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<CAC|"}, {"variables",std::vector<std::string>{"|<CAC|"}}}}, {"object2",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",13}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>ABA|"}, {"variables",std::vector<std::string>{"|>ABA|"}}}}, {"object2",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",14}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<ABA|"}, {"variables",std::vector<std::string>{"|<ABA|"}}}}, {"object2",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",15}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>CBC|"}, {"variables",std::vector<std::string>{"|>CBC|"}}}}, {"object2",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",16}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<CBC|"}, {"variables",std::vector<std::string>{"|<CBC|"}}}}, {"object2",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",17}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>ACA|"}, {"variables",std::vector<std::string>{"|>ACA|"}}}}, {"object2",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",18}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<ACA|"}, {"variables",std::vector<std::string>{"|<ACA|"}}}}, {"object2",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",19}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>BCB|"}, {"variables",std::vector<std::string>{"|>BCB|"}}}}, {"object2",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",20}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<BCB|"}, {"variables",std::vector<std::string>{"|<BCB|"}}}}, {"object2",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",22}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"value","|>ABC|"}, {"variables",std::vector<std::string>{"|>ABC|"}}}}, {"object2",{{"value","50"},{"variables",std::vector<std::string>{}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::USER_DEFINED}} ,{"type",DependencyType::ANGLE_MEASURE}}
  };

  const json expectedFormulas{
    {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",23}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"value","a*3^-1"}, {"variables", std::vector<std::string>{"a"}}}}, {"object2",{{"value","x"}, {"variables", std::vector<std::string>{"x"}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type",DependencyType::EQUATION}},
    {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",24}, {"importance",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"value","x"}, {"variables", std::vector<std::string>{"x"}}}}, {"object2",{{"value","|AC|-7"}, {"variables", std::vector<std::string>{"|AC|"}}}}, {"reason",std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type",DependencyType::EQUATION}}
  };
...
TEST_CASE("Importing task(part 2) and exporting empty solution from expert", "[expert]") {
  ...
  const std::vector<json> expectedPerpendicularLines{
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_LINES}, {"id",654}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L24"}}}, {"object2",{{"id","jxgBoard1L31"}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::PERPENDICULAR_LINES}}
  };

  const std::vector<json> expectedMidPerpendicularLines{
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_LINE_AND_POINTS_PAIR}, {"id",661}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L40"}}}, {"object2",{{"end1Id","jxgBoard1P20"}, {"end2Id","jxgBoard1P22"}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::MID_PERPENDICULAR_LINE}}
  };

  const std::vector<json> expectedBisectors{
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_LINE_AND_ANGLE}, {"id",659}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L63"}}}, {"object2",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P45"}, {"vertexId","jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::BISECTOR_LINE}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_LINE_AND_ANGLE}, {"id",660}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L82"}}}, {"object2",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P51"}, {"vertexId","jxgBoard1P49"}, {"type", AngleType::CONVEX}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::BISECTOR_LINE}}
  };

  const std::vector<json> expectedLineCircles{
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_LINE_AND_CIRCLE}, {"id",656}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L90"}}}, {"object2",{{"id","jxgBoard1C87"}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::TANGENT_LINE_TO_CIRCLE}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_LINE_AND_CIRCLE}, {"id",657}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L90"}}}, {"object2",{{"id","jxgBoard1C95"}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::TANGENT_LINE_TO_CIRCLE}}
  };

  const std::vector<json> expectedCircleCircles{
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_CIRCLES}, {"id",658}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1C100"}}}, {"object2",{{"id","jxgBoard1C95"}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::TANGENT_CIRCLE_TO_CIRCLE}}
  };
 
  REQUIRE(parallelLines == json(expectedParallelLines));
  REQUIRE(perpendicularLines == json(expectedPerpendicularLines));
  REQUIRE(midPerpendicularLines == json(expectedMidPerpendicularLines));
...
TEST_CASE("Importing task(part 3) and exporting empty solution from expert", "[expert]") {
  ...
  const std::vector<json> expectedEqualSegments{
    ...
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POINTS_PAIRS}, {"id",1246}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"end1Id","jxgBoard1P20"}, {"end2Id","jxgBoard1P25"}}}, {"object2",{{"end1Id","jxgBoard1P22"}, {"end2Id","jxgBoard1P27"}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_SEGMENTS}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POINTS_PAIRS}, {"id",1247}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"end1Id","jxgBoard1P25"}, {"end2Id","jxgBoard1P27"}}}, {"object2",{{"end1Id","jxgBoard1P22"}, {"end2Id","jxgBoard1P27"}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_SEGMENTS}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POINTS_PAIRS}, {"id",1248}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"end1Id","jxgBoard1P101"}, {"end2Id","jxgBoard1P103"}}}, {"object2",{{"end1Id","jxgBoard1P108"}, {"end2Id","jxgBoard1P110"}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_SEGMENTS}},
  };

  const std::vector<json> expectedEqualAngles{
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1249}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P35"}, {"point2Id","jxgBoard1P47"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1250}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P35"}, {"point2Id","jxgBoard1P47"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1251}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P35"}, {"point2Id","jxgBoard1P47"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P39"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1252}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P35"}, {"point2Id","jxgBoard1P47"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P39"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1253}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P39"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1254}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P39"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1255}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1256}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1257}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1258}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1259}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1260}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1261}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1262}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1263}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1264}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1265}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1266}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1267}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P117"}, {"point2Id","jxgBoard1P128"}, {"vertexId", "jxgBoard1P119"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P139"}, {"point2Id","jxgBoard1P154"}, {"vertexId", "jxgBoard1P141"}, {"type", AngleType::CONVEX}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1268}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P117"}, {"point2Id","jxgBoard1P128"}, {"vertexId", "jxgBoard1P119"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P139"}, {"point2Id","jxgBoard1P154"}, {"vertexId", "jxgBoard1P141"}, {"type", AngleType::CONCAVE}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
  };
...
TEST_CASE("Importing task(part 4) and exporting empty solution from expert", "[expert]") {
  ...
  const std::vector<json> expectedAltitudes{
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POLYGON_AND_POINTS_PAIRS}, {"id",1129}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P31", "jxgBoard1P29", "jxgBoard1P34"}}}}, {"object2",{{"end1Id","jxgBoard1P31"}, {"end2Id","jxgBoard1P67"}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::ALTITUDE}}
  };

  const std::vector<json> expectedMidSegments{
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POLYGON_AND_POINTS_PAIRS}, {"id",1130}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P38", "jxgBoard1P43", "jxgBoard1P40", "jxgBoard1P46"}}}}, {"object2",{{"end1Id","jxgBoard1P74"}, {"end2Id","jxgBoard1P80"}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::MID_SEGMENT}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POLYGON_AND_POINTS_PAIRS}, {"id",1131}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P89", "jxgBoard1P87", "jxgBoard1P92", "jxgBoard1P89"}}}}, {"object2",{{"end1Id","jxgBoard1P102"}, {"end2Id","jxgBoard1P96"}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::MID_SEGMENT}}
  };

  const std::vector<json> expectedPerimeters{
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POLYGON_AND_EXPRESSION}, {"id",1126}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P50", "jxgBoard1P52", "jxgBoard1P54", "jxgBoard1P56", "jxgBoard1P58"}}}}, {"object2",{{"value","32"}, {"variables",std::vector<std::string>{}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_PERIMETER}}
  };

  const std::vector<json> expectedAreas{
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POLYGON_AND_EXPRESSION}, {"id",1127}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P50", "jxgBoard1P52", "jxgBoard1P54", "jxgBoard1P56", "jxgBoard1P58"}}}}, {"object2",{{"value","214"}, {"variables",std::vector<std::string>{}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_AREA}}
  };
...
TEST_CASE("Importing task(part 5) and exporting empty solution from expert", "[expert]") {
  ...
  const std::vector<json> expectedPolygonTypes{
    ...
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5616}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::EQUILATERAL_TRIANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P31", "jxgBoard1P33", "jxgBoard1P35"}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5617}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::ISOSCELES_ACUTE_TRIANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P37", "jxgBoard1P39", "jxgBoard1P42"}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5618}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::ISOSCELES_RIGHT_TRIANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P44", "jxgBoard1P46", "jxgBoard1P48"}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5619}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::OBTUSE_ISOSCELES_TRIANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P54", "jxgBoard1P56", "jxgBoard1P59"}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5620}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::SQUARE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P76", "jxgBoard1P78", "jxgBoard1P80", "jxgBoard1P82"}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5621}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::RECTANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P84", "jxgBoard1P86", "jxgBoard1P89", "jxgBoard1P91"}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5622}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::REGULAR_POLYGON))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P93", "jxgBoard1P95", "jxgBoard1P97", "jxgBoard1P99", "jxgBoard1P101", "jxgBoard1P103"}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5623}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::PARALLELOGRAM))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P105", "jxgBoard1P107", "jxgBoard1P109", "jxgBoard1P111"}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5624}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::KITE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P131", "jxgBoard1P133", "jxgBoard1P135", "jxgBoard1P137"}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5625}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::RHOMBUS))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P143", "jxgBoard1P145", "jxgBoard1P148", "jxgBoard1P150"}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5626}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::SCALENE_TRAPEZOID))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P156", "jxgBoard1P158", "jxgBoard1P160", "jxgBoard1P163"}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5627}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::ISOSCELES_TRAPEZOID))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P165", "jxgBoard1P167", "jxgBoard1P169", "jxgBoard1P171"}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5628}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::RIGHT_TRAPEZOID))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P185", "jxgBoard1P187", "jxgBoard1P189", "jxgBoard1P192"}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}}
  };
...
TEST_CASE("Importing task(part 6) and exporting empty solution from expert", "[expert]") {
  ...
  const std::vector<json> expectedCircumscribedCircles{
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_CIRCLE_AND_POLYGON}, {"id",937}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1C60"}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P20", "jxgBoard1P22", "jxgBoard1P24", "jxgBoard1P26", "jxgBoard1P28"}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::CIRCUMSCRIBED_CIRCLE}}
  };

  const std::vector<json> expectedEscribedCircles{
    {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_CIRCLE_AND_POLYGON}, {"id",938}, {"importance", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1C57"}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P38", "jxgBoard1P43", "jxgBoard1P40"}}}}, {"reason", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::ESCRIBED_CIRCLE}}
  };
