...
TEST_CASE("Importing task(part 2) and exporting empty solution from expert", "[expert]") {
  ...
  const std::vector<json> expectedParallelLines{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_LINES}, {"id",663}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id","jxgBoard1L24"}}}, {"object2",{{"id","jxgBoard1L28"}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::PARALLEL_LINES}}
  };
  
  const std::vector<json> expectedPerpendicularLines{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_LINES}, {"id",662}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id","jxgBoard1L24"}}}, {"object2",{{"id","jxgBoard1L31"}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::PERPENDICULAR_LINES}}
  };

  const std::vector<json> expectedMidPerpendicualarLines{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_LINE_AND_POINTS_PAIR}, {"id",669}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id","jxgBoard1L40"}}}, {"object2",{{"end1Id","jxgBoard1P20"}, {"end2Id","jxgBoard1P22"}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::MID_PERPENDICULAR_LINE}}
  };

  const std::vector<json> expectedBisectors{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_LINE_AND_ANGLE}, {"id",667}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id","jxgBoard1L63"}}}, {"object2",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P45"}, {"vertexId","jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::BISECTOR_LINE}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_LINE_AND_ANGLE}, {"id",668}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id","jxgBoard1L82"}}}, {"object2",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P51"}, {"vertexId","jxgBoard1P49"}, {"type", AngleType::CONVEX}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::BISECTOR_LINE}}
  };

  const std::vector<json> expectedLineCircles{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_LINE_AND_CIRCLE}, {"id",664}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id","jxgBoard1L90"}}}, {"object2",{{"id","jxgBoard1C87"}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::TANGENT_LINE_TO_CIRCLE}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_LINE_AND_CIRCLE}, {"id",665}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id","jxgBoard1L90"}}}, {"object2",{{"id","jxgBoard1C95"}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::TANGENT_LINE_TO_CIRCLE}}
  };

  const std::vector<json> expectedCircleCircles{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_CIRCLES}, {"id",666}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id","jxgBoard1C100"}}}, {"object2",{{"id","jxgBoard1C95"}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::TANGENT_CIRCLE_TO_CIRCLE}}
  };
...
TEST_CASE("Importing task(part 3) and exporting empty solution from expert", "[expert]") {
  ...
  const std::vector<json> expectedEqualSegments{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_POINTS_PAIRS}, {"id",1263}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"end1Id","jxgBoard1P20"}, {"end2Id","jxgBoard1P25"}}}, {"object2",{{"end1Id","jxgBoard1P25"}, {"end2Id","jxgBoard1P27"}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_SEGMENTS}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_POINTS_PAIRS}, {"id",1264}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"end1Id","jxgBoard1P20"}, {"end2Id","jxgBoard1P25"}}}, {"object2",{{"end1Id","jxgBoard1P22"}, {"end2Id","jxgBoard1P27"}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_SEGMENTS}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_POINTS_PAIRS}, {"id",1265}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"end1Id","jxgBoard1P25"}, {"end2Id","jxgBoard1P27"}}}, {"object2",{{"end1Id","jxgBoard1P22"}, {"end2Id","jxgBoard1P27"}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_SEGMENTS}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_POINTS_PAIRS}, {"id",1266}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"end1Id","jxgBoard1P101"}, {"end2Id","jxgBoard1P103"}}}, {"object2",{{"end1Id","jxgBoard1P108"}, {"end2Id","jxgBoard1P110"}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_SEGMENTS}},
  };

  const std::vector<json> expectedEqualAngles{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1267}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P35"}, {"point2Id","jxgBoard1P47"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1268}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P35"}, {"point2Id","jxgBoard1P47"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1269}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P35"}, {"point2Id","jxgBoard1P47"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P39"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1270}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P35"}, {"point2Id","jxgBoard1P47"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P39"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1271}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P39"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1272}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P39"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1273}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1274}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1275}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1276}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1277}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1278}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1279}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1280}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1281}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1282}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1283}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1284}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1285}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P117"}, {"point2Id","jxgBoard1P128"}, {"vertexId", "jxgBoard1P119"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P139"}, {"point2Id","jxgBoard1P154"}, {"vertexId", "jxgBoard1P141"}, {"type", AngleType::CONVEX}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_ANGLES}, {"id",1286}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"point1Id","jxgBoard1P117"}, {"point2Id","jxgBoard1P128"}, {"vertexId", "jxgBoard1P119"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P139"}, {"point2Id","jxgBoard1P154"}, {"vertexId", "jxgBoard1P141"}, {"type", AngleType::CONCAVE}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::EQUAL_ANGLES}},      
  };
...
TEST_CASE("Importing task(part 4) and exporting empty solution from expert", "[expert]") {
  ...
  const std::vector<json> expectedMedians{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_POLYGON_AND_POINTS_PAIRS}, {"id",1158}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P22", "jxgBoard1P20", "jxgBoard1P25"})}}}, {"object2",{{"end1Id","jxgBoard1P22"}, {"end2Id","jxgBoard1P60"}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::MEDIAN}}
  };

  const std::vector<json> expectedAltitudes{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_POLYGON_AND_POINTS_PAIRS}, {"id",1159}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P31", "jxgBoard1P29", "jxgBoard1P34"})}}}, {"object2",{{"end1Id","jxgBoard1P31"}, {"end2Id","jxgBoard1P67"}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::ALTITUDE}}
  };

  const std::vector<json> expectedMidSegments{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_POLYGON_AND_POINTS_PAIRS}, {"id",1160}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P38", "jxgBoard1P43", "jxgBoard1P40", "jxgBoard1P46"})}}}, {"object2",{{"end1Id","jxgBoard1P74"}, {"end2Id","jxgBoard1P80"}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::MID_SEGMENT}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_POLYGON_AND_POINTS_PAIRS}, {"id",1161}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P89", "jxgBoard1P87", "jxgBoard1P92", "jxgBoard1P89"})}}}, {"object2",{{"end1Id","jxgBoard1P102"}, {"end2Id","jxgBoard1P96"}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::MID_SEGMENT}}
  };

  const std::vector<json> expectedPerimeters{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_POLYGON_AND_EXPRESSION}, {"id",1156}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P50", "jxgBoard1P52", "jxgBoard1P54", "jxgBoard1P56", "jxgBoard1P58"})}}}, {"object2",{{"value","32"}, {"variables",json(std::vector<std::string>{})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_PERIMETER}}
  };

  const std::vector<json> expectedAreas{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_POLYGON_AND_EXPRESSION}, {"id",1157}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P50", "jxgBoard1P52", "jxgBoard1P54", "jxgBoard1P56", "jxgBoard1P58"})}}}, {"object2",{{"value","214"}, {"variables",json(std::vector<std::string>{})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_AREA}}
  };
...
TEST_CASE("Importing task(part 5) and exporting empty solution from expert", "[expert]") {
  ...
  const std::vector<json> expectedPolygonTypes{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5671}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::SCALENE_RIGHT_TRIANGLE))}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P20", "jxgBoard1P22", "jxgBoard1P25"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_TYPE}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5672}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::EQUILATERAL_TRIANGLE))}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P31", "jxgBoard1P33", "jxgBoard1P35"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_TYPE}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5673}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::ISOSCELES_ACUTE_TRIANGLE))}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P37", "jxgBoard1P39", "jxgBoard1P42"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_TYPE}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5674}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::ISOSCELES_RIGHT_TRIANGLE))}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P44", "jxgBoard1P46", "jxgBoard1P48"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_TYPE}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5675}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::OBTUSE_ISOSCELES_TRIANGLE))}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P54", "jxgBoard1P56", "jxgBoard1P59"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_TYPE}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5676}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::SQUARE))}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P76", "jxgBoard1P78", "jxgBoard1P80", "jxgBoard1P82"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_TYPE}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5677}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::RECTANGLE))}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P84", "jxgBoard1P86", "jxgBoard1P89", "jxgBoard1P91"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_TYPE}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5678}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::REGULAR_POLYGON))}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P93", "jxgBoard1P95", "jxgBoard1P97", "jxgBoard1P99", "jxgBoard1P101", "jxgBoard1P103"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_TYPE}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5679}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::PARALLELOGRAM))}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P105", "jxgBoard1P107", "jxgBoard1P109", "jxgBoard1P111"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_TYPE}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5680}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::KITE))}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P131", "jxgBoard1P133", "jxgBoard1P135", "jxgBoard1P137"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_TYPE}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5681}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::RHOMBUS))}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P143", "jxgBoard1P145", "jxgBoard1P148", "jxgBoard1P150"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_TYPE}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5682}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::SCALENE_TRAPEZOID))}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P156", "jxgBoard1P158", "jxgBoard1P160", "jxgBoard1P163"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_TYPE}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5683}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::ISOSCELES_TRAPEZOID))}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P165", "jxgBoard1P167", "jxgBoard1P169", "jxgBoard1P171"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_TYPE}},
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5684}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::RIGHT_TRAPEZOID))}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P185", "jxgBoard1P187", "jxgBoard1P189", "jxgBoard1P192"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::POLYGON_TYPE}}
  };
...
TEST_CASE("Importing task(part 6) and exporting empty solution from expert", "[expert]") {
  ...
  const std::vector<json> expectedInscribedCircles{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_CIRCLE_AND_POLYGON}, {"id",966}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id","jxgBoard1C80"}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P36", "jxgBoard1P34", "jxgBoard1P32", "jxgBoard1P30"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::INSCRIBED_CIRCLE}}
  };

  const std::vector<json> expectedCircumscribedCircles{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_CIRCLE_AND_POLYGON}, {"id",967}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id","jxgBoard1C60"}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P20", "jxgBoard1P22", "jxgBoard1P24", "jxgBoard1P26", "jxgBoard1P28"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::CIRCUMSCRIBED_CIRCLE}}
  };

  const std::vector<json> expectedEscribedCircles{
    {{"basedOn", json(std::vector<size_t>{})}, {"category", DependencyCategory::OF_CIRCLE_AND_POLYGON}, {"id",968}, {"importance", DependencyImportanceLevel::HIGH}, {"object1",{{"id","jxgBoard1C57"}}}, {"object2",{{"verticesIds",json(std::vector<std::string>{"jxgBoard1P38", "jxgBoard1P43", "jxgBoard1P40"})}}}, {"reason", DependencyReason::USER_DEFINED}, {"type", DependencyType::ESCRIBED_CIRCLE}}
  };
