...
TEST_CASE("Empty expert", "[expert]") {
  ...
  const json rootDependency{
      {"id", 0},
      {"category", DependencyCategory ::EXERCISE_DESCRIPTION},
      {"type", DependencyType ::EXERCISE_DESCRIPTION},
      {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}},
      {"dependentDependencies", std::vector<std::vector<size_t>>{}},
      {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}
  };
  ...
  REQUIRE_NOTHROW(expert.importTask(emptyInputJson, trash));
  REQUIRE_NOTHROW(expert.useKnowledge(trash));
  REQUIRE(expert.exportSolution(trash) == emptyOutputJson);
}
...
TEST_CASE("Importing task(shapes part) and exporting empty solution from expert", "[expert]") {
  ...
  const json expectedLines{
      {{"object", {{"a", 0.28484848141670227}, {"b",40.25059127807617}, {"end1Id","jxgBoard1P79"}, {"end2Id","jxgBoard1P81"}, {"id","jxgBoard1L83"}, {"pointsOn", std::vector<std::string>{"jxgBoard1P79","jxgBoard1P108","jxgBoard1P98","jxgBoard1P86","jxgBoard1P81"}}, {"type",LineType::SLANTED}}}, {"position",0}},
      {{"object", {{"a", 0.0}, {"b",33.78289794921875}, {"end1Id","jxgBoard1P47"}, {"end2Id","jxgBoard1P106"}, {"id","jxgBoard1L64"}, {"pointsOn", std::vector<std::string>{"jxgBoard1P47","jxgBoard1P62","jxgBoard1P98","jxgBoard1P106"}}, {"type",LineType::VERTICAL}}}, {"position",1}},
      {{"object", {{"a", 0.0}, {"b",-59.8684196472168}, {"end1Id","jxgBoard1P100"}, {"end2Id","jxgBoard1P102"}, {"id","jxgBoard1L49"}, {"pointsOn", std::vector<std::string>{"jxgBoard1P100","jxgBoard1P47","jxgBoard1P60","jxgBoard1P36","jxgBoard1P102"}}, {"type",LineType::HORIZONTAL}}}, {"position", 2}}
  };
  ...
  REQUIRE_NOTHROW(expert.importTask(task1, trash));
  const json solution = expert.exportSolution(trash);
...
TEST_CASE("Importing task(part 1) and exporting empty solution from expert", "[expert]") {
  ...
  const json expectedLengths = {
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",1}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|AA|"}, {"variables",std::vector<std::string>{"|AA|"}}}}, {"object1",{{"value","0"}, {"variables", std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::SEGMENT_LENGTH}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",4}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|BB|"}, {"variables",std::vector<std::string>{"|BB|"}}}}, {"object1",{{"value","0"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::SEGMENT_LENGTH}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",7}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|CC|"}, {"variables",std::vector<std::string>{"|CC|"}}}}, {"object1",{{"value","0"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::SEGMENT_LENGTH}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",22}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object2",{{"value","|AC|"}, {"variables",std::vector<std::string>{"|AC|"}}}}, {"object1",{{"value","5*x"}, {"variables",std::vector<std::string>{"x"}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type",DependencyType::SEGMENT_LENGTH}}
  };

  const json expectedMeasures = {
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",2}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|>AAA|"}, {"variables",std::vector<std::string>{"|>AAA|"}}}}, {"object1",{{"value","0"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",3}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|<AAA|"}, {"variables",std::vector<std::string>{"|<AAA|"}}}}, {"object1",{{"value","360"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",5}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|>BBB|"}, {"variables",std::vector<std::string>{"|>BBB|"}}}}, {"object1",{{"value","0"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",6}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|<BBB|"}, {"variables",std::vector<std::string>{"|<BBB|"}}}}, {"object1",{{"value","360"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",8}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|>CCC|"}, {"variables",std::vector<std::string>{"|>CCC|"}}}}, {"object1",{{"value","0"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",9}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|<CCC|"}, {"variables",std::vector<std::string>{"|<CCC|"}}}}, {"object1",{{"value","360"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",10}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|>BAB|"}, {"variables",std::vector<std::string>{"|>BAB|"}}}}, {"object1",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",11}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|<BAB|"}, {"variables",std::vector<std::string>{"|<BAB|"}}}}, {"object1",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",12}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|>CAC|"}, {"variables",std::vector<std::string>{"|>CAC|"}}}}, {"object1",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",13}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|<CAC|"}, {"variables",std::vector<std::string>{"|<CAC|"}}}}, {"object1",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",14}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|>ABA|"}, {"variables",std::vector<std::string>{"|>ABA|"}}}}, {"object1",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",15}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|<ABA|"}, {"variables",std::vector<std::string>{"|<ABA|"}}}}, {"object1",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",16}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|>CBC|"}, {"variables",std::vector<std::string>{"|>CBC|"}}}}, {"object1",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",17}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|<CBC|"}, {"variables",std::vector<std::string>{"|<CBC|"}}}}, {"object1",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",18}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|>ACA|"}, {"variables",std::vector<std::string>{"|>ACA|"}}}}, {"object1",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",19}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|<ACA|"}, {"variables",std::vector<std::string>{"|<ACA|"}}}}, {"object1",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",20}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|>BCB|"}, {"variables",std::vector<std::string>{"|>BCB|"}}}}, {"object1",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",21}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object2",{{"value","|<BCB|"}, {"variables",std::vector<std::string>{"|<BCB|"}}}}, {"object1",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",23}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object2",{{"value","|<ABC|"}, {"variables",std::vector<std::string>{"|<ABC|"}}}}, {"object1",{{"value","50"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::USER_DEFINED}} ,{"type",DependencyType::ANGLE_MEASURE}}
  };

  const json expectedFormulas{
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",24}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"value","a*3^-1"}, {"variables", std::vector<std::string>{"a"}}}}, {"object2",{{"value","x"}, {"variables", std::vector<std::string>{"x"}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type",DependencyType::EQUATION}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{0}}}, {"category",DependencyCategory::FORMULA}, {"id",25}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"value","x"}, {"variables", std::vector<std::string>{"x"}}}}, {"object2",{{"value","|AC|-7"}, {"variables", std::vector<std::string>{"|AC|"}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type",DependencyType::EQUATION}}
  };

  Expert expert{};
  std::ofstream trash{"trash.txt"};

  REQUIRE_NOTHROW(expert.importTask(task2, trash));
  const json solution = expert.exportSolution(trash);
  ...
  REQUIRE((expectedLengths.size() + expectedMeasures.size() + expectedFormulas.size() + 1) == solution["dependencies"].size());

  std::cout << solution["dependencies"] << std::endl;
  ...
  for(const auto& form: expectedFormulas) {
    ...
    if(!found) { std::cout << form << std::endl; }
    REQUIRE(found);
  }
}
...
TEST_CASE("Importing task(part 2) and exporting empty solution from expert", "[expert]") {
  ...
  REQUIRE_NOTHROW(expert.importTask(task3, trash));
  const json solution = expert.exportSolution(trash);
  ...
  const std::vector<json> expectedParallelLines{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_LINES}, {"id",656}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L24"}}}, {"object2",{{"id","jxgBoard1L28"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::PARALLEL_LINES}}
  };

  const std::vector<json> expectedPerpendicularLines{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_LINES}, {"id",655}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L24"}}}, {"object2",{{"id","jxgBoard1L31"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::PERPENDICULAR_LINES}}
  };

  const std::vector<json> expectedMidPerpendicularLines{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_LINE_AND_POINTS_PAIR}, {"id",662}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L40"}}}, {"object2",{{"end1Id","jxgBoard1P20"}, {"end2Id","jxgBoard1P22"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::MID_PERPENDICULAR_LINE}}
  };

  const std::vector<json> expectedBisectors{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_LINE_AND_ANGLE}, {"id",660}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L63"}}}, {"object2",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P45"}, {"vertexId","jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::BISECTOR_LINE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_LINE_AND_ANGLE}, {"id",661}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L82"}}}, {"object2",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P51"}, {"vertexId","jxgBoard1P49"}, {"type", AngleType::CONVEX}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::BISECTOR_LINE}}
  };

  const std::vector<json> expectedLineCircles{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_LINE_AND_CIRCLE}, {"id",657}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L90"}}}, {"object2",{{"id","jxgBoard1C87"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::TANGENT_LINE_TO_CIRCLE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_LINE_AND_CIRCLE}, {"id",658}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L90"}}}, {"object2",{{"id","jxgBoard1C95"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::TANGENT_LINE_TO_CIRCLE}}
  };

  const std::vector<json> expectedCircleCircles{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_CIRCLES}, {"id",659}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1C100"}}}, {"object2",{{"id","jxgBoard1C95"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::TANGENT_CIRCLE_TO_CIRCLE}}
  };
...
TEST_CASE("Importing task(part 3) and exporting empty solution from expert", "[expert]") {
  ...
  REQUIRE_NOTHROW(expert.importTask(task4, trash));
  const json solution = expert.exportSolution(trash);
  ...
  const std::vector<json> expectedEqualSegments{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POINTS_PAIRS}, {"id",1246}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"end1Id","jxgBoard1P20"}, {"end2Id","jxgBoard1P25"}}}, {"object2",{{"end1Id","jxgBoard1P25"}, {"end2Id","jxgBoard1P27"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_SEGMENTS}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POINTS_PAIRS}, {"id",1247}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"end1Id","jxgBoard1P20"}, {"end2Id","jxgBoard1P25"}}}, {"object2",{{"end1Id","jxgBoard1P22"}, {"end2Id","jxgBoard1P27"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_SEGMENTS}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POINTS_PAIRS}, {"id",1248}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"end1Id","jxgBoard1P25"}, {"end2Id","jxgBoard1P27"}}}, {"object2",{{"end1Id","jxgBoard1P22"}, {"end2Id","jxgBoard1P27"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_SEGMENTS}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POINTS_PAIRS}, {"id",1249}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"end1Id","jxgBoard1P101"}, {"end2Id","jxgBoard1P103"}}}, {"object2",{{"end1Id","jxgBoard1P108"}, {"end2Id","jxgBoard1P110"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_SEGMENTS}},
  };

  const std::vector<json> expectedEqualAngles{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1250}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P35"}, {"point2Id","jxgBoard1P47"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1251}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P35"}, {"point2Id","jxgBoard1P47"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1252}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P35"}, {"point2Id","jxgBoard1P47"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P39"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1253}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P35"}, {"point2Id","jxgBoard1P47"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P39"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1254}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P39"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONVEX}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1255}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P39"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::CONCAVE}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1256}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1257}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1258}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1259}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1260}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1261}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1262}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1263}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1264}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1265}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1266}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONVEX}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1267}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1268}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P117"}, {"point2Id","jxgBoard1P128"}, {"vertexId", "jxgBoard1P119"}, {"type", AngleType::CONVEX}}}, {"object2",{{"point1Id","jxgBoard1P139"}, {"point2Id","jxgBoard1P154"}, {"vertexId", "jxgBoard1P141"}, {"type", AngleType::CONVEX}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1269}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P117"}, {"point2Id","jxgBoard1P128"}, {"vertexId", "jxgBoard1P119"}, {"type", AngleType::CONCAVE}}}, {"object2",{{"point1Id","jxgBoard1P139"}, {"point2Id","jxgBoard1P154"}, {"vertexId", "jxgBoard1P141"}, {"type", AngleType::CONCAVE}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
  };
...
TEST_CASE("Importing task(part 4) and exporting empty solution from expert", "[expert]") {
  ...
  REQUIRE_NOTHROW(expert.importTask(task5, trash));
  const json solution = expert.exportSolution(trash);
  ...
  const std::vector<json> expectedMedians{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POLYGON_AND_POINTS_PAIRS}, {"id",1129}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P22", "jxgBoard1P20", "jxgBoard1P25"}}}}, {"object2",{{"end1Id","jxgBoard1P22"}, {"end2Id","jxgBoard1P60"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::MEDIAN}}
  };

  const std::vector<json> expectedAltitudes{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POLYGON_AND_POINTS_PAIRS}, {"id",1130}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P31", "jxgBoard1P29", "jxgBoard1P34"}}}}, {"object2",{{"end1Id","jxgBoard1P31"}, {"end2Id","jxgBoard1P67"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::ALTITUDE}}
  };

  const std::vector<json> expectedMidSegments{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POLYGON_AND_POINTS_PAIRS}, {"id",1131}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P38", "jxgBoard1P43", "jxgBoard1P40", "jxgBoard1P46"}}}}, {"object2",{{"end1Id","jxgBoard1P74"}, {"end2Id","jxgBoard1P80"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::MID_SEGMENT}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POLYGON_AND_POINTS_PAIRS}, {"id",1132}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P89", "jxgBoard1P87", "jxgBoard1P92", "jxgBoard1P89"}}}}, {"object2",{{"end1Id","jxgBoard1P102"}, {"end2Id","jxgBoard1P96"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::MID_SEGMENT}}
  };

  const std::vector<json> expectedPerimeters{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POLYGON_AND_EXPRESSION}, {"id",1127}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P50", "jxgBoard1P52", "jxgBoard1P54", "jxgBoard1P56", "jxgBoard1P58"}}}}, {"object2",{{"value","32"}, {"variables",std::vector<std::string>{}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_PERIMETER}}
  };

  const std::vector<json> expectedAreas{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_POLYGON_AND_EXPRESSION}, {"id",1128}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P50", "jxgBoard1P52", "jxgBoard1P54", "jxgBoard1P56", "jxgBoard1P58"}}}}, {"object2",{{"value","214"}, {"variables",std::vector<std::string>{}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_AREA}}
  };
...
TEST_CASE("Importing task(part 5) and exporting empty solution from expert", "[expert]") {
  ...
  REQUIRE_NOTHROW(expert.importTask(task6, trash));
  const json solution = expert.exportSolution(trash);
  ...
  const std::vector<json> expectedPolygonTypes{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5616}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::SCALENE_RIGHT_TRIANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P20", "jxgBoard1P22", "jxgBoard1P25"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5617}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::EQUILATERAL_TRIANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P31", "jxgBoard1P33", "jxgBoard1P35"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5618}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::ISOSCELES_ACUTE_TRIANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P37", "jxgBoard1P39", "jxgBoard1P42"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5619}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::ISOSCELES_RIGHT_TRIANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P44", "jxgBoard1P46", "jxgBoard1P48"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5620}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::OBTUSE_ISOSCELES_TRIANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P54", "jxgBoard1P56", "jxgBoard1P59"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5621}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::SQUARE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P76", "jxgBoard1P78", "jxgBoard1P80", "jxgBoard1P82"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5622}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::RECTANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P84", "jxgBoard1P86", "jxgBoard1P89", "jxgBoard1P91"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5623}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::REGULAR_POLYGON))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P93", "jxgBoard1P95", "jxgBoard1P97", "jxgBoard1P99", "jxgBoard1P101", "jxgBoard1P103"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5624}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::PARALLELOGRAM))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P105", "jxgBoard1P107", "jxgBoard1P109", "jxgBoard1P111"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5625}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::KITE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P131", "jxgBoard1P133", "jxgBoard1P135", "jxgBoard1P137"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5626}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::RHOMBUS))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P143", "jxgBoard1P145", "jxgBoard1P148", "jxgBoard1P150"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5627}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::SCALENE_TRAPEZOID))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P156", "jxgBoard1P158", "jxgBoard1P160", "jxgBoard1P163"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5628}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::ISOSCELES_TRAPEZOID))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P165", "jxgBoard1P167", "jxgBoard1P169", "jxgBoard1P171"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5629}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::RIGHT_TRAPEZOID))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P185", "jxgBoard1P187", "jxgBoard1P189", "jxgBoard1P192"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}}
  };
...
TEST_CASE("Importing task(part 6) and exporting empty solution from expert", "[expert]") {
  ...
  REQUIRE_NOTHROW(expert.importTask(task7, trash));
  const json solution = expert.exportSolution(trash);
  ...
  const std::vector<json> expectedInscribedCircles{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_CIRCLE_AND_POLYGON}, {"id",937}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1C80"}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P36", "jxgBoard1P34", "jxgBoard1P32", "jxgBoard1P30"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::INSCRIBED_CIRCLE}}
  };

  const std::vector<json> expectedCircumscribedCircles{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_CIRCLE_AND_POLYGON}, {"id",938}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1C60"}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P20", "jxgBoard1P22", "jxgBoard1P24", "jxgBoard1P26", "jxgBoard1P28"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::CIRCUMSCRIBED_CIRCLE}}
  };

  const std::vector<json> expectedEscribedCircles{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{}}}, {"category", DependencyCategory::OF_CIRCLE_AND_POLYGON}, {"id",939}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1C57"}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P38", "jxgBoard1P43", "jxgBoard1P40"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::ESCRIBED_CIRCLE}}
  };
