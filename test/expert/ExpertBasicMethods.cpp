...
TEST_CASE("Importing task(part 2) and exporting empty solution from expert", "[expert]") {
  ...
  const std::vector<json> expectedParallelLines{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_LINES}, {"id",664}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L24"}}}, {"object2",{{"id","jxgBoard1L28"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::PARALLEL_LINES}}
  };

  const std::vector<json> expectedPerpendicularLines{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_LINES}, {"id",663}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L24"}}}, {"object2",{{"id","jxgBoard1L31"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::PERPENDICULAR_LINES}}
  };

  const std::vector<json> expectedMidPerpendicularLines{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_LINE_AND_POINTS_PAIR}, {"id",670}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L40"}}}, {"object2",{{"end1Id","jxgBoard1P20"}, {"end2Id","jxgBoard1P22"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::MID_PERPENDICULAR_LINE}}
  };

  const std::vector<json> expectedBisectors{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_LINE_AND_ANGLE}, {"id",668}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L63"}}}, {"object2",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P45"}, {"vertexId","jxgBoard1P43"}, {"type", AngleType::CONCAVE}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::BISECTOR_LINE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_LINE_AND_ANGLE}, {"id",669}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L82"}}}, {"object2",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P51"}, {"vertexId","jxgBoard1P49"}, {"type", AngleType::CONVEX}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::BISECTOR_LINE}}
  };

  const std::vector<json> expectedLineCircles{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_LINE_AND_CIRCLE}, {"id",665}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L90"}}}, {"object2",{{"id","jxgBoard1C87"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::TANGENT_LINE_TO_CIRCLE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_LINE_AND_CIRCLE}, {"id",666}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1L90"}}}, {"object2",{{"id","jxgBoard1C95"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::TANGENT_LINE_TO_CIRCLE}}
  };

  const std::vector<json> expectedCircleCircles{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_CIRCLES}, {"id",667}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1C100"}}}, {"object2",{{"id","jxgBoard1C95"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::TANGENT_CIRCLE_TO_CIRCLE}}
  };
...
TEST_CASE("Importing task(part 3) and exporting empty solution from expert", "[expert]") {
  ...
  const std::vector<json> expectedEqualSegments{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_POINTS_PAIRS}, {"id",1264}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"end1Id","jxgBoard1P20"}, {"end2Id","jxgBoard1P25"}}}, {"object2",{{"end1Id","jxgBoard1P25"}, {"end2Id","jxgBoard1P27"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_SEGMENTS}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_POINTS_PAIRS}, {"id",1265}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"end1Id","jxgBoard1P20"}, {"end2Id","jxgBoard1P25"}}}, {"object2",{{"end1Id","jxgBoard1P22"}, {"end2Id","jxgBoard1P27"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_SEGMENTS}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_POINTS_PAIRS}, {"id",1266}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"end1Id","jxgBoard1P25"}, {"end2Id","jxgBoard1P27"}}}, {"object2",{{"end1Id","jxgBoard1P22"}, {"end2Id","jxgBoard1P27"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_SEGMENTS}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_POINTS_PAIRS}, {"id",1267}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"end1Id","jxgBoard1P101"}, {"end2Id","jxgBoard1P103"}}}, {"object2",{{"end1Id","jxgBoard1P108"}, {"end2Id","jxgBoard1P110"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_SEGMENTS}},
  };

  const std::vector<json> expectedEqualAngles{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1268}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P35"}, {"point2Id","jxgBoard1P47"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::UNKNOWN}}}, {"object2",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::UNKNOWN}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1269}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P35"}, {"point2Id","jxgBoard1P47"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::UNKNOWN}}}, {"object2",{{"point1Id","jxgBoard1P39"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::UNKNOWN}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1270}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P47"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::UNKNOWN}}}, {"object2",{{"point1Id","jxgBoard1P39"}, {"point2Id","jxgBoard1P49"}, {"vertexId", "jxgBoard1P37"}, {"type", AngleType::UNKNOWN}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1271}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::UNKNOWN}}}, {"object2",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::UNKNOWN}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1272}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::UNKNOWN}}}, {"object2",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::UNKNOWN}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1273}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P41"}, {"point2Id","jxgBoard1P63"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::UNKNOWN}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::UNKNOWN}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1274}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::UNKNOWN}}}, {"object2",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::UNKNOWN}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1275}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P63"}, {"point2Id","jxgBoard1P65"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::UNKNOWN}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::UNKNOWN}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1276}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P65"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::UNKNOWN}}}, {"object2",{{"point1Id","jxgBoard1P45"}, {"point2Id","jxgBoard1P67"}, {"vertexId", "jxgBoard1P43"}, {"type", AngleType::UNKNOWN}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_ANGLES}, {"id",1277}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"point1Id","jxgBoard1P117"}, {"point2Id","jxgBoard1P128"}, {"vertexId", "jxgBoard1P119"}, {"type", AngleType::UNKNOWN}}}, {"object2",{{"point1Id","jxgBoard1P139"}, {"point2Id","jxgBoard1P154"}, {"vertexId", "jxgBoard1P141"}, {"type", AngleType::UNKNOWN}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::EQUAL_ANGLES}}
  };
...
TEST_CASE("Importing task(part 4) and exporting empty solution from expert", "[expert]") {
  ...
  const std::vector<json> expectedMedians{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_POLYGON_AND_POINTS_PAIRS}, {"id",1159}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P22", "jxgBoard1P20", "jxgBoard1P25"}}}}, {"object2",{{"end1Id","jxgBoard1P22"}, {"end2Id","jxgBoard1P60"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::MEDIAN}}
  };

  const std::vector<json> expectedAltitudes{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_POLYGON_AND_POINTS_PAIRS}, {"id",1160}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P31", "jxgBoard1P29", "jxgBoard1P34"}}}}, {"object2",{{"end1Id","jxgBoard1P31"}, {"end2Id","jxgBoard1P67"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::ALTITUDE}}
  };

  const std::vector<json> expectedMidSegments{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_POLYGON_AND_POINTS_PAIRS}, {"id",1161}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P38", "jxgBoard1P43", "jxgBoard1P40", "jxgBoard1P46"}}}}, {"object2",{{"end1Id","jxgBoard1P74"}, {"end2Id","jxgBoard1P80"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::MID_SEGMENT}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_POLYGON_AND_POINTS_PAIRS}, {"id",1162}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P89", "jxgBoard1P87", "jxgBoard1P92", "jxgBoard1P89"}}}}, {"object2",{{"end1Id","jxgBoard1P102"}, {"end2Id","jxgBoard1P96"}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::MID_SEGMENT}}
  };

  const std::vector<json> expectedPerimeters{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_POLYGON_AND_EXPRESSION}, {"id",1157}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P50", "jxgBoard1P52", "jxgBoard1P54", "jxgBoard1P56", "jxgBoard1P58"}}}}, {"object2",{{"value","32"}, {"variables",std::vector<std::string>{}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_PERIMETER}}
  };

  const std::vector<json> expectedAreas{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_POLYGON_AND_EXPRESSION}, {"id",1158}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"verticesIds",std::vector<std::string>{"jxgBoard1P50", "jxgBoard1P52", "jxgBoard1P54", "jxgBoard1P56", "jxgBoard1P58"}}}}, {"object2",{{"value","214"}, {"variables",std::vector<std::string>{}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_AREA}}
  };
...
TEST_CASE("Importing task(part 5) and exporting empty solution from expert", "[expert]") {
  ...
  const std::vector<json> expectedPolygonTypes{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5672}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::SCALENE_RIGHT_TRIANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P20", "jxgBoard1P22", "jxgBoard1P25"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5673}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::EQUILATERAL_TRIANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P31", "jxgBoard1P33", "jxgBoard1P35"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5674}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::ISOSCELES_ACUTE_TRIANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P37", "jxgBoard1P39", "jxgBoard1P42"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5675}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::ISOSCELES_RIGHT_TRIANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P44", "jxgBoard1P46", "jxgBoard1P48"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5676}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::OBTUSE_ISOSCELES_TRIANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P54", "jxgBoard1P56", "jxgBoard1P59"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5677}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::SQUARE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P76", "jxgBoard1P78", "jxgBoard1P80", "jxgBoard1P82"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5678}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::RECTANGLE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P84", "jxgBoard1P86", "jxgBoard1P89", "jxgBoard1P91"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5679}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::REGULAR_POLYGON))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P93", "jxgBoard1P95", "jxgBoard1P97", "jxgBoard1P99", "jxgBoard1P101", "jxgBoard1P103"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5680}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::PARALLELOGRAM))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P105", "jxgBoard1P107", "jxgBoard1P109", "jxgBoard1P111"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5681}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::KITE))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P131", "jxgBoard1P133", "jxgBoard1P135", "jxgBoard1P137"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5682}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::RHOMBUS))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P143", "jxgBoard1P145", "jxgBoard1P148", "jxgBoard1P150"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5683}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::SCALENE_TRAPEZOID))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P156", "jxgBoard1P158", "jxgBoard1P160", "jxgBoard1P163"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5684}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::ISOSCELES_TRAPEZOID))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P165", "jxgBoard1P167", "jxgBoard1P169", "jxgBoard1P171"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}},
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::POLYGON_TYPE}, {"id",5685}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id",std::to_string(static_cast<unsigned int>(PolygonType::RIGHT_TRAPEZOID))}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P185", "jxgBoard1P187", "jxgBoard1P189", "jxgBoard1P192"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::POLYGON_TYPE}}
  };
...
TEST_CASE("Importing task(part 6) and exporting empty solution from expert", "[expert]") {
  ...
  const std::vector<json> expectedInscribedCircles{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_CIRCLE_AND_POLYGON}, {"id",967}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1C80"}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P36", "jxgBoard1P34", "jxgBoard1P32", "jxgBoard1P30"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::INSCRIBED_CIRCLE}}
  };

  const std::vector<json> expectedCircumscribedCircles{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_CIRCLE_AND_POLYGON}, {"id",968}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1C60"}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P20", "jxgBoard1P22", "jxgBoard1P24", "jxgBoard1P26", "jxgBoard1P28"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::CIRCUMSCRIBED_CIRCLE}}
  };

  const std::vector<json> expectedEscribedCircles{
      {{"dependentDependencies", std::vector<std::vector<size_t>>{{0}}}, {"category", DependencyCategory::OF_CIRCLE_AND_POLYGON}, {"id",969}, {"importances", std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"id","jxgBoard1C57"}}}, {"object2",{{"verticesIds",std::vector<std::string>{"jxgBoard1P38", "jxgBoard1P43", "jxgBoard1P40"}}}}, {"reasons", std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type", DependencyType::ESCRIBED_CIRCLE}}
  };
