...
TEST_CASE("Importing task(part 1) and exporting empty solution from expert", "[expert]") {
  ...
  const json expectedLengths = {
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",1}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|AA|"}, {"variables",std::vector<std::string>{"|AA|"}}}}, {"object2",{{"value","0"}, {"variables", std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::SEGMENT_LENGTH}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",4}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|BB|"}, {"variables",std::vector<std::string>{"|BB|"}}}}, {"object2",{{"value","0"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::SEGMENT_LENGTH}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",7}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|CC|"}, {"variables",std::vector<std::string>{"|CC|"}}}}, {"object2",{{"value","0"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::SEGMENT_LENGTH}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",22}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"value","|AC|"}, {"variables",std::vector<std::string>{"|AC|"}}}}, {"object2",{{"value","5*x"}, {"variables",std::vector<std::string>{"x"}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type",DependencyType::SEGMENT_LENGTH}}
  };

  const json expectedMeasures = {
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",2}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>AAA|"}, {"variables",std::vector<std::string>{"|>AAA|"}}}}, {"object2",{{"value","0"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",3}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<AAA|"}, {"variables",std::vector<std::string>{"|<AAA|"}}}}, {"object2",{{"value","360"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",5}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>BBB|"}, {"variables",std::vector<std::string>{"|>BBB|"}}}}, {"object2",{{"value","0"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",6}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<BBB|"}, {"variables",std::vector<std::string>{"|<BBB|"}}}}, {"object2",{{"value","360"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",8}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>CCC|"}, {"variables",std::vector<std::string>{"|>CCC|"}}}}, {"object2",{{"value","0"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",9}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<CCC|"}, {"variables",std::vector<std::string>{"|<CCC|"}}}}, {"object2",{{"value","360"}, {"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::POINTS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",10}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>BAB|"}, {"variables",std::vector<std::string>{"|>BAB|"}}}}, {"object2",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",11}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<BAB|"}, {"variables",std::vector<std::string>{"|<BAB|"}}}}, {"object2",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",12}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>CAC|"}, {"variables",std::vector<std::string>{"|>CAC|"}}}}, {"object2",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",13}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<CAC|"}, {"variables",std::vector<std::string>{"|<CAC|"}}}}, {"object2",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",14}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>ABA|"}, {"variables",std::vector<std::string>{"|>ABA|"}}}}, {"object2",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",15}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<ABA|"}, {"variables",std::vector<std::string>{"|<ABA|"}}}}, {"object2",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",16}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>CBC|"}, {"variables",std::vector<std::string>{"|>CBC|"}}}}, {"object2",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",17}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<CBC|"}, {"variables",std::vector<std::string>{"|<CBC|"}}}}, {"object2",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",18}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>ACA|"}, {"variables",std::vector<std::string>{"|>ACA|"}}}}, {"object2",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",19}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<ACA|"}, {"variables",std::vector<std::string>{"|<ACA|"}}}}, {"object2",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",20}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|>BCB|"}, {"variables",std::vector<std::string>{"|>BCB|"}}}}, {"object2",{{"value","0"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",21}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::LOW}}, {"object1",{{"value","|<BCB|"}, {"variables",std::vector<std::string>{"|<BCB|"}}}}, {"object2",{{"value","360"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::ARMS_ARE_THE_SAME}}, {"type",DependencyType::ANGLE_MEASURE}},
      {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",23}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"value","|>ABC|"}, {"variables",std::vector<std::string>{"|>ABC|"}}}}, {"object2",{{"value","50"},{"variables",std::vector<std::string>{}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::USER_DEFINED}} ,{"type",DependencyType::ANGLE_MEASURE}}
  };

  const json expectedFormulas{
    {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",24}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"value","a*3^-1"}, {"variables", std::vector<std::string>{"a"}}}}, {"object2",{{"value","x"}, {"variables", std::vector<std::string>{"x"}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type",DependencyType::EQUATION}},
    {{"dependentDependencies",std::vector<std::vector<size_t>>{{}}}, {"category",DependencyCategory::FORMULA}, {"id",25}, {"importances",std::vector<DependencyImportanceLevel>{DependencyImportanceLevel::HIGH}}, {"object1",{{"value","x"}, {"variables", std::vector<std::string>{"x"}}}}, {"object2",{{"value","|AC|-7"}, {"variables", std::vector<std::string>{"|AC|"}}}}, {"reasons",std::vector<DependencyReason>{DependencyReason::USER_DEFINED}}, {"type",DependencyType::EQUATION}}
  };
